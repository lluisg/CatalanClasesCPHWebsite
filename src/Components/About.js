    ...
    <div id="about-section" className='section about-section card-section'>
      ...
      <div className='about-body'>
        <div className="about-text">
          ...
          <p className='text-maria'>I was born in the beautiful city of Barcelona but I am currently living in Copenhagen, a city that I fell in love when I was 21. I am a book lover, I am very curious and I love to discover new places and languages. I speak Spanish, Catalan, English, a little bit of French and my next objective is Danish.</p>
          ...
          <p className='text-maria'>During the last four years, I have worked as a teacher in primary schools, associations and different language academies for adults in Barcelona. \nTeaching my languages has allowed me to see the world with different eyes and learn every day from my students. Without a doubt I can say that being a teacher is the most beautiful challenge.</p>
        </div>
